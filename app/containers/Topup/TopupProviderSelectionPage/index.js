...
export default withRouter(withAudio({ src: 'http://localhost:8888/vms/html-v2/voice/6.m4a' }, actions)(connect(mapStateToProps, mapDispatchToProps)(TopupProviderSelectionPage)))
